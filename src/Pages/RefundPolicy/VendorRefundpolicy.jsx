...
const VendorRefundpolicy = () => {
    ...
    const [refundType, setRefundType] = useState('vendor');
    ...
    const fetchRefundPolicyData = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${BaseUrl}api/v1/refundPolicy/vendor`, getAuthHeaders());
...
export default HOC(VendorRefundpolicy);
