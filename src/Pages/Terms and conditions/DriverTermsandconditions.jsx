...
const DriverTermsandconditions = () => {
    ...
    const [termsType, setTermsType] = useState('driver');
    ...
    const fetchTermsData = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${BaseUrl}api/v1/terms/driver`, getAuthHeaders());
                ...
                <div className='rider1'>
                    <div className='rider2'>
                        <div className='rider3'>
                            <h6>Driver Terms and Conditions</h6>
                        </div>
...
export default HOC(DriverTermsandconditions);
