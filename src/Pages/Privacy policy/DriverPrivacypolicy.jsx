...
const DriverPrivacypolicy = () => {
    ...
    const [privacyType, setPrivacyType] = useState('driver');
    ...
    const fetchPrivacyData = () => {
        axios
            .get(`${BaseUrl}api/v1/privacy/type/driver`, getAuthHeaders())
            .then(response => {
                    ...
                    <div className='terms'>
                        {loading ? (
                            ...
                            <div className='terms1'>
                                <p>No Privacy Policys available. Press 'Add' to add new Privacy Policys.</p>
                            </div>
                        ) : (
...
export default HOC(DriverPrivacypolicy);
